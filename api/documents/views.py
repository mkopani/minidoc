...
class DocumentViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        full_serializer = DocumentSerializer(partial_serializer.instance, context=self.get_serializer_context())
    ...
    def update(self, request, *args, **kwargs):
        ...
        partial_serializer = self.get_serializer(instance, data=request.data, partial=True)
        partial_serializer.is_valid(raise_exception=True)
